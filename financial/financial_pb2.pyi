...
class Product(_message.Message):
    __slots__ = ("id", "organization_id", "product_type_id", "created_by", "updated_by", "name", "display_name", "description", "picture", "slug", "uuid", "object_type", "object_id", "currency_id", "price", "created_at", "updated_at")
    ID_FIELD_NUMBER: _ClassVar[int]
    ORGANIZATION_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    created_at: _timestamp_pb2.Timestamp
    updated_at: _timestamp_pb2.Timestamp
    def __init__(self, id: _Optional[int] = ..., organization_id: _Optional[int] = ..., product_type_id: _Optional[int] = ..., created_by: _Optional[int] = ..., updated_by: _Optional[int] = ..., name: _Optional[str] = ..., display_name: _Optional[str] = ..., description: _Optional[str] = ..., picture: _Optional[str] = ..., slug: _Optional[str] = ..., uuid: _Optional[str] = ..., object_type: _Optional[str] = ..., object_id: _Optional[int] = ..., currency_id: _Optional[int] = ..., price: _Optional[float] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class PaymentGateway(_message.Message):
    ...
    default: bool
    status: bool
    config: _containers.RepeatedCompositeFieldContainer[PaymentGateway.Config]
    created_at: _timestamp_pb2.Timestamp
    updated_at: _timestamp_pb2.Timestamp
    def __init__(self, id: _Optional[int] = ..., organization_id: _Optional[int] = ..., created_by: _Optional[int] = ..., updated_by: _Optional[int] = ..., gateway: _Optional[str] = ..., name: _Optional[str] = ..., default: bool = ..., status: bool = ..., config: _Optional[_Iterable[_Union[PaymentGateway.Config, _Mapping]]] = ..., created_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
